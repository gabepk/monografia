...
\indent Diferente do mapa de objetivos, a modelagem de tarefas não se foca em definir as permissões de usuários nem os tipos de objetivos (finais ou instrumentais). Ela tem a finalidade de apresentar em formato de árvore as navegações que um usuário genérico pode realizar no sistema a partir de um objetivo. Em um sistema de grande porte, podem existir diversos diagramas de tarefas, um para cada objetivo de usuário. 
