...
\begin{figure}[h]
    ...
    \caption{Nucleotídeo cuja grupo fosfato (P) está em amarela, a pentose está em cinza e base nitrogenada, no caso a Guanina, em azul. Adaptado de \cite{dnadiscovery08}. }
...
\begin{figure}[h]
    ...
    \caption{Representação das duas fitas de DNA se ligando por pontes de hidrogênio entre os nucleotídeos e formando seu \textit{backbone}. Adaptado de \cite{dnadiscovery08}.}
...
\indent Diferente das ferramentas do KEGG e Reactome, o Pathway  Tools não possui um mapa global de visualização das vias metabólicas. Para acessá-las, o usuário deve buscar por alguma palavra chave conhecida ou navegar pelo sumário de vias\footnote{Na última visita, em 2016-10-06, a página possuia 3461 vias metabólicas.} classificado hierarquicamente com base em suas funções biológicas e na classe dos metabólitos produzidos\/consumidos. O acesso à via da Figura \ref{fig:bioLuz}, por exemplo, se deu pela nagevação a partir da \textit{home page}: \\
