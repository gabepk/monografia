...
\indent Nesta seção, inicialmente descrevemos os ácidos nucleicos (DNA e RNA), e em seguida proteínas e o Dogma Central.
...
%A Figura \ref{fig:bioLuz} apresenta um exemplo de via metabólica, a bioluminescência de uma bactéria. Ela possui oito reações (arestas), quatro produtos intermediários e um produto final, que é um photon (luz).

%\begin{figure}[h]
%    \centering
%    \includegraphics[width=0.75\textwidth]{bioLuz.png}
%    \caption{Exemplo de via metabólica retirado do MetaCyC~\cite{examplePathway}, que representa o processo de produção da bioluminescência de bactérias. As setas representam reações e os rótulos representam substratos e produtos, que podem ser en}
%    \label{fig:bioLuz}
%\end{figure}
