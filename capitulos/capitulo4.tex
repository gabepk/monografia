...
\indent Após responderem o questionário, cada usuário fará o teste separadamente, sem ter acesso às respostas de outro usuário para que o teste não perca a legitimidade. Apenas um avaliador guiará os usuários e apenas um computador será utilizado para os testes. Assim, serão realizados três testes em sequência. Será utilizado um computador pessoal para a realização das tarefas, ao invés de um computador do Laboratório de Bioinformática, uma vez que o ambiente de teste já está pronto no computador pessoal.

\indent Os usuários serão filmados a tela do computador, o \textit{mouse}/\textit{mousepad}, o teclado e as mãos do usuários. Serão apresentadas as 13 etiquetas, descritas no capítulo 3, para cada usuário
